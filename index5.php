    ...
    <script>
        $(document).ready(function() {
            ...
            function displayBuildDetails(buildData) {
                ...
                clone.querySelector('.build-name').textContent = buildData.name;
                clone.querySelector('.overview-text').textContent = buildData.overview;
                clone.querySelector('.leveling-text').textContent = buildData.leveling_guide;
